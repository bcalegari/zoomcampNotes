...
# Load data from a .parquet or .csv file to a Postgres database
# Usage: python data-loading.py --user <username> --password <password> --host <hostname> --port <port> --db <database> --tb <table> --url <url>
...
if __name__ == '__main__':
    #Parsing arguments 
    parser = argparse.ArgumentParser(description='Loading data from .paraquet or .csv file link to a Postgres datebase.')
